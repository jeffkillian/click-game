...
function (_React$Component) {
  ...
  function AppContent(options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(AppContent).call(this, options));

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "clickSuccess", function () {
      var clicks = _this.state.clicks + 1;
      var randomX = Math.max(Math.random() * window.innerWidth - _this.SQUAREDIM, 0);
      var randomY = Math.max(Math.random() * window.innerHeight - _this.SQUAREDIM, 0);
      ...
      if (clicks == 10) _this.endGame();
    });

    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "endGame", function () {
      _this.scores.push(_this.state.timeElapsed);

      console.log(_this.scores);

      if (_this.state.highScore === null || _this.state.timeElapsed < _this.state.highScore) {
        _this.setState({
          highScore: _this.state.timeElapsed
        });
      }
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "begin", function () {
      _this.timer = setInterval(_this.changeTime.bind(_assertThisInitialized(_assertThisInitialized(_this))), 10);
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "resetGame", function () {
      _this.setState({
        gameState: "ready",
        clicks: 1
      });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "changeTime", function () {
      _this.setState({
        timeElapsed: Date.now() - _this.state.startTime
      });
    });

    var hi = _assertThisInitialized(_assertThisInitialized(_this));
  ...
  _createClass(AppContent, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, this.renderTimeElapsed(), this.renderContents());
    }
  }, {
    key: "renderContents",
    ...
    key: "renderEndScreen",
    value: function renderEndScreen() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Time elapsed: ", this.renderTimeElapsed()), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Best Score: ", this.formatTime(this.state.highScore)), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        onClick: this.resetGame
      }, "Restart"));
    }
  }, {
    key: "renderTimeElapsed",
    value: function renderTimeElapsed() {
    ...
    key: "renderBeginScreen",
    value: function renderBeginScreen() {
      var divStyle = {
        position: "absolute",
        "background": "grey",
        width: "100px",
    ...
    value: function renderSquare() {
      var divStyle = {
        position: "absolute",
        "background": "#86e0a7",
        width: "".concat(this.SQUAREDIM, "px"),
        height: "".concat(this.SQUAREDIM, "px"),
        top: this.state.y,
        left: this.state.x,
        "font-size": "40px",
        color: "white",
